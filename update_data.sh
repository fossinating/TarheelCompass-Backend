...
psql $CONNECTION -d tarheel_compass -c DROP TABLE IF EXISTS class,class_reserve_capacity,class_schedule,course,course_attributes,instructor,schedule_instructor_join_table,term,term_source;
